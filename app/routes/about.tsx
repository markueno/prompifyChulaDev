...
export const links: LinksFunction = () => [
  { rel: 'canonical', href: 'https://prompify.com/about' },
];
...
export const meta: MetaFunction = () => [
  ...
  { property: 'og:url', content: 'https://prompify.com/about' },
...
const orgSchema = {
  ...
  '@type': 'Organization',
  name: 'Prompify',
  url: 'https://prompify.com',
  logo: 'https://prompify.com/prompify1.png',
  description:
  ...
  foundingDate: '',
  contactPoint: [{ '@type': 'ContactPoint', contactType: 'support', email: '', url: 'https://prompify.com/about' }],
};
    ...
    <LandingAppChrome>
      ...
      <main className="mx-auto w-full max-w-3xl px-6 pb-24 text-bolt-elements-textPrimary">
        ...
        <p className="mt-4 text-lg text-bolt-elements-textSecondary">
          Prompify turns plain-English prompts into working, live web apps you can run in your
          browser.
        </p>
        ...
        <section className="mt-12">
          ...
          <div className="mt-3 rounded-lg border border-bolt-elements-borderColor p-4">
            ...
            <p className="text-bolt-elements-textSecondary">
              <em>Founder &amp; team bio — to be added.</em> This section is intentionally a
              placeholder. When you have a real founder name, role, and a short first-person bio,
              add it here (and set the <code>founder</code> field in the JSON-LD above).
            </p>
          </div>
        </section>
        ...
        <section className="mt-10">
          ...
          <p className="mt-3 text-bolt-elements-textSecondary">
            ...
            <em>Founding story — to be added.</em> Describe the problem you set out to solve and
            why an AI app builder was the answer.
          </p>
        </section>
        ...
        <section className="mt-10">
          ...
          <p className="mt-3 text-bolt-elements-textSecondary">
            <em>Contact details — to be added.</em> Set a real support email and the{' '}
            <code>contactPoint</code> in the Organization JSON-LD above when available.
          </p>
        </section>
        ...
        <section className="mt-12">
          ...
          <div className="mt-3 space-y-4">
            <div>
              ...
              <p className="text-bolt-elements-textSecondary">
                An AI app builder: describe what you need in plain English and get a working, live
            ...
            <div>
              ...
              <p className="text-bolt-elements-textSecondary">
                You write a prompt; Prompify generates the code, runs it in a WebContainer, saves it
                as a version, and lets you edit or deploy.
              </p>
            </div>
            <div>
