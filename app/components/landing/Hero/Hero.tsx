      ...
      <section className="hero-section" ref={heroSectionRef} id="heroSection">
        <div className="content" ref={contentRef} id="content">
          ...
          <h1 className="heading">
            <span className="highlight">Prompify</span>
            <br />
            Your Ideas
          </h1>

          <p className="subtitle">Build what you need before your coffee gets cold.</p>

          <div className="prompt-wrapper">
            <div className="prompt-box">
              {/* Messages area — hidden until first message */}
              <div ref={messagesAreaRef} className={`messages-area${messages.length > 0 ? ' has-messages' : ''}`}>
                {messages.map((msg, i) => (
