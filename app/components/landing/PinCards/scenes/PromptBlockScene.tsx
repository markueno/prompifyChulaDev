    ...
    <>
      ...
      <group ref={groupRef}>
        ...
        <group ref={browserGroupRef} scale={0}>
          ...
          <Text position={[-1.5, 1.6, 0.2]} fontSize={0.09} color="#64748b" anchorX="left" anchorY="middle">
            https://prompify.app
          </Text>
          ...
          <Text position={[-2.1, 1.08, 0.19]} fontSize={0.15} color="#ff6b00" anchorX="left" anchorY="middle">
            Prompify
          </Text>
          ...
          <Text position={[2.0, 1.08, 0.2]} fontSize={0.09} color="#ffffff" anchorX="center" anchorY="middle">
            Get Started
          </Text>

          {/* Hero section */}
          <Text position={[-1.8, 0.5, 0.18]} fontSize={0.28} color="#0f172a" anchorX="left" anchorY="middle">
            Build Apps with AI
          </Text>
          ...
          <Text
            ...
            maxWidth={3}
          >
            Describe your idea in plain English and get a working app instantly. No coding required.
          </Text>
          ...
          <Text position={[-1.8, -0.25, 0.19]} fontSize={0.1} color="#ffffff" anchorX="center" anchorY="middle">
            Start Prompting
          </Text>
          ...
          {FEATURES.map((feature, i) => {
            ...
            return (
              <group key={i}>
                ...
                <Text position={[x, -1.0, 0.19]} fontSize={0.08} color="#94a3b8" anchorX="center" anchorY="middle">
                  {feature.desc}
                </Text>
              </group>
            );
