...
const REGIONS = [
  {
    ...
    label: { top: '6%', left: '50%' },
    insight:
      'Our AI carries deep institutional knowledge of the Education sector — from curriculum design and learning outcomes to funding models and regulatory frameworks — enabling it to interpret your challenges with genuine domain fluency.',
  },
  {
    name: 'Health',
    color: 0x5a9e6e,
    ...
    label: { top: '6%', left: '50%' },
    insight:
      'With comprehensive awareness of clinical workflows, patient-centric care models, and healthcare compliance landscapes, our AI engages with your problems the way a seasoned industry expert would.',
  },
  {
    name: 'Finance',
    color: 0xc49a30,
    ...
    label: { top: '6%', left: '50%' },
    insight:
      'From capital markets and risk modelling to regulatory compliance and fintech disruption, our AI understands the nuances of financial services and applies that precision to every problem you bring.',
  },
  {
    name: 'Retail',
    color: 0xd06040,
    ...
    label: { top: '6%', left: '50%' },
    insight:
      'Steeped in the dynamics of consumer behaviour, supply chain logistics, and omnichannel strategy, our AI deciphers retail complexities and delivers solutions grounded in real-world commercial context.',
  },
  {
    name: 'Tech',
    color: 0xb05868,
    ...
    label: { top: '6%', left: '50%' },
    insight:
      'Our AI is fluent in the architecture, product cycles, and innovation pressures unique to the technology industry — allowing it to engage with your technical and strategic challenges at a sophisticated level.',
  },
  {
    name: 'Government',
    color: 0x7870a8,
    ...
    label: { top: '6%', left: '50%' },
    insight:
      'Versed in policy design, public service delivery, and the governance structures that shape decision-making, our AI navigates the complexities of the public sector with clarity and contextual depth.',
  },
];
...
export default function BusinessIntelligenceVisual() {
  ...
  return (
    <div className="w-full h-full relative overflow-hidden" style={{ background: 'transparent', minHeight: '320px' }}>
      ...
      {status === 'error' && (
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <p style={{ color: '#a07050', fontSize: '0.8rem', opacity: 0.6 }}>3D view unavailable on this device.</p>
        </div>
      )}
