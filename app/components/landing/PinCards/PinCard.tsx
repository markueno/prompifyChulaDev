...
export default function PinCard({ heading, description, index, children }: PinCardProps) {
  return (
    <section className="pin-card" style={{ background: 'transparent' }}>
      <div className="pin-card-inner" style={{ background: 'transparent' }}>
        ...
        <div className="pin-card-canvas">{children}</div>
      </div>
    </section>
  );
}
