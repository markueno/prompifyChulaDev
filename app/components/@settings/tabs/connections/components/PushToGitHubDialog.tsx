...
export function PushToGitHubDialog({ isOpen, onClose, onPush }: PushToGitHubDialogProps) {
  ...
  // Defaults to private: a generated app can carry real config and seed data.
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex justify-end gap-2 pt-2">
                    <motion.a
                      ...
                      className="px-4 py-2 rounded-lg bg-[#f97316] text-white hover:bg-[#ea5a0c] text-sm inline-flex items-center gap-2"
              ...
              <Dialog.Content className="bg-white dark:bg-[#0A0A0A] rounded-lg p-6 border border-[#E5E5E5] dark:border-[#1A1A1A] shadow-xl">
                <div className="text-center space-y-4">
                  <motion.div
                    ...
                    className="mx-auto w-12 h-12 rounded-xl bg-bolt-elements-background-depth-3 flex items-center justify-center text-[#f97316]"
                  >
                  ...
                  <motion.button
                    className="px-4 py-2 rounded-lg bg-[#f97316] text-white text-sm hover:bg-[#ea5a0c] inline-flex items-center gap-2"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    onClick={handleClose}
                  >
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                  <motion.div
                    ...
                    animate={{ scale: 1 }}
                    transition={{ delay: 0.1 }}
                    className="w-10 h-10 rounded-xl bg-bolt-elements-background-depth-3 flex items-center justify-center text-[#f97316]"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div className="space-y-2">
                        {recentRepos.map(repo => (
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <div className="i-ph:git-repository w-4 h-4 text-[#f97316]" />
                                <span className="text-sm font-medium text-gray-900 dark:text-white group-hover:text-[#f97316]">
                                  {repo.name}
                                </span>
                              </div>
                              {repo.private && (
                                <span className="text-xs px-2 py-1 rounded-full bg-[#f97316]/10 text-[#f97316]">
                                  Private
                                </span>
                              )}
                            </div>
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="rounded border-[#E5E5E5] dark:border-[#1A1A1A] text-[#f97316] focus:ring-[#f97316] dark:bg-[#0A0A0A]"
                    />
                  ...
                  <div className="pt-4 flex gap-2">
                    ...
                    <motion.button
                      ...
                      className={classNames(
                        'flex-1 px-4 py-2 bg-[#f97316] text-white rounded-lg hover:bg-[#ea5a0c] text-sm inline-flex items-center justify-center gap-2',
