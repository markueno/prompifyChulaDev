  ...
  const getNotificationStyle = (level: string, type?: string) => {
    if (type === 'update') {
      return {
        ...
        color: 'text-[#f97316] dark:text-[#f97316]/80',
        bg: 'hover:bg-[#f97316]/10 dark:hover:bg-[#f97316]/20',
      };
    }
  ...
  return (
    <div className="flex h-full flex-col gap-6">
      <div className="flex items-center justify-between">
        ...
        >
          <span className="i-ph:trash text-lg text-gray-500 dark:text-gray-400 group-hover:text-[#f97316] transition-colors" />
          Clear All
        </button>
      </div>
