  ...
  ({ chatStarted, isStreaming, actionRunner, metadata, updateChatMestaData }: WorkspaceProps) => {
    ...
    return (
      chatStarted && (
        ...
        >
          {/*
           * Sits flush under the header. It used to start 1.5rem below it with a 1.5rem bottom
           * gap and up to 1.5rem of side padding, which read as an awkward dead band above the
           * preview and cost real vertical space on a laptop.
           */}
          <div
